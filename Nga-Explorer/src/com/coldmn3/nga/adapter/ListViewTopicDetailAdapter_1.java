...
public class ListViewTopicDetailAdapter_1 extends BaseAdapter {
	...
	public ListViewTopicDetailAdapter_1(Context context, List<TopicFloor> data) {
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (cachedView != null) {
			...
			viewHolder.container = (LinearLayout) convertView.findViewById(R.id.content_container);
